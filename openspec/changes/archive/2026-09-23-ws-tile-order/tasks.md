...
- [x] 4.1 Вид плитки стола при переключении workspace: иконки workspace стоят на своих местах, неактивный затенён, иконок его окон нет (проверяет пользователь) — 23.09.2026 пользователь тем же днём задал новый вид плитки активного стола (изменение `ws-tile-tabs`), проверка вида переходит туда
