...
- [x] 5.1 Продиктовать фразу при играющем видео в браузере и при звуке
...
Проверено пользователем 22.09.2026: звук выключается на время записи и распознавания, видео в Яндекс.Браузере встаёт на паузу после возврата флага `hardware-media-key-handling` в «Default» (без него браузер не был MPRIS-плеером; записано в `docs/media-and-portals.md`).
