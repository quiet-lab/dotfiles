...
- [ ] 5.1 Окно при запросе пароля выглядит как плитка панели (заливка, рамка, шрифт, пояснение над полем), значок показывает набранный пароль, Escape отменяет — `sudo` сообщает, что пароль не предоставлен
- [ ] 5.2 Панель выглядит как до переноса оформления: плитки, всплывающие окна, уведомления, окно подсказки клавиш
