...
2. Попросить пользователя проверить панель мышью после исправления подсказок: подсказки плиток не пропадают при движении по соседним значкам, меню и панель громкости (спецификации qs-shell, qs-tray-lang). Задержки у подсказок нет по решению пользователя 22.09.2026.
