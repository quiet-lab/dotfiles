...
- Вид плитки активного стола после изменения `ws-tile-tabs` (пункт 5.1 его `tasks.md`): двойная высота, сверху табы workspace в порядке попадания на стол (активный чёрный и слит с рядом окон, неактивные на серой полосе), снизу окна активного workspace и свободные окна; плитки ниже сдвинуты, трей 312 px, плитка уведомлений на y = 1416. Если вид устраивает — при архивации поправить раздел Purpose спецификации qs-workspaces (пункт 4.1) и заархивировать.
