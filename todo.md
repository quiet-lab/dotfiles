...
- [ ] Проверить настоящей диктовкой при RU, что после вставки текста
      кириллица печатается сразу (изменение `voxtype-restore-layout`,
      пункт проверки в его `tasks.md`); если да — архивировать.
